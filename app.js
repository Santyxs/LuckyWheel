...
function Winwheel(options, drawImmediately) {
    ...
    Winwheel.prototype.startAnimation = function () {
        if (this.animation) {
            ...
            // Reproducir sonido
            const ruletaSound = new Audio("sounds/ruleta.mp3");
            ...
            this.animation.velocity = Math.random() * 10 + 40; // Velocidad inicial aleatoria (40-50 grados/frame)
            this.animation.friction = Math.random() * 0.01 + 0.985; // Fricción aleatoria (0.985-0.995)
            this.animation.finalFriction = Math.random() * 0.005 + 0.990; // Frenado final (0.990-0.995)
            this.animation.slowingDown = false;
            this.animation.minVelocity = Math.random() * 0.2 + 0.1; // Velocidad mínima variable (0.1-0.3)
            this.animation.stopOffset = Math.random() * 30 - 15; // Variación del punto de parada (-15° a +15°)
...
/* ---------- 2) Renderizado de texto de los segmentos ---------- */
Winwheel.prototype.drawSegmentText = function () {
...
/* ---------- 3) Inicialización y giro de la ruleta ---------- */
let theWheel;
...
/* ---------- 4) Gestión de la lista de participantes ---------- */
document.addEventListener("DOMContentLoaded", () => {
    ...
    collapsibleButton.addEventListener("click", () => {
        ...
        collapsibleButton.setAttribute("aria-expanded", String(!isOpen));
    });
